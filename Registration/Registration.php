...
<form method="post">
        ...
        <tr>
            ...
            <td colspan="2"><input type="text" name="txtempid"size="10">
				<input type="button" name="Search" value="Search"/></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3" align="center">
				...
				<button value="Update" id="btn2"  style="width:120px; height: 40px;">Update</button>&nbsp;&nbsp;&nbsp;
				<button value="delete" id="btn3"  style="width:120px; height: 40px;">Delete</button>&nbsp;&nbsp;&nbsp;
...
$dated1 = date('d-m-y', strtotime($_POST['dated']));
...
$sql = "INSERT INTO registration_form (Employee_Id, First_Name, Middle_Name, Last_Name, Gender, Mobile_No, Address, Email, Addhar_No, Username, Password)
values ('$txtempid','$txtfn','$txtmn','$txtln','$Gender','$txtmno','$txtaddress','$txtemailid','$txtadharno','$txtun','$txtpass')";
